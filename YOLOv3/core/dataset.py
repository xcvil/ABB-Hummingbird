...
class Dataset(object):
    ...
    def __init__(self, dataset_type):
        self.annot_path  = cfg.TRAIN.ANNOT_PATH if dataset_type == 'train' else cfg.VAL.ANNOT_PATH
        self.input_sizes = cfg.TRAIN.INPUT_SIZE if dataset_type == 'train' else cfg.VAL.INPUT_SIZE
        self.batch_size  = cfg.TRAIN.BATCH_SIZE if dataset_type == 'train' else cfg.VAL.BATCH_SIZE
        # self.batch_size = 4
        self.data_aug    = cfg.TRAIN.DATA_AUG   if dataset_type == 'train' else cfg.VAL.DATA_AUG
